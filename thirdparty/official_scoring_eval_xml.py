#!/usr/bin/env python
### *********** Provided by Biocreative for evalution !!!
...
gold_standard_collection = bioc.load(gold_standard_file)

prediction_collection = bioc.load(prediction_file)


if subtask == 'triage':
    gold_standard_positive, gold_standard_negative = BioC_Collection_Triage(gold_standard_collection)
    average_precision, precision, recall, f1, tp, fp, tn, fn = Classification_Performance_Triage(
        prediction_collection, gold_standard_positive, gold_standard_negative)
    ...
    gold_standard_ids, gold_standard_relations = BioC_Collection_Relation(gold_standard_collection)
    micro_precision, micro_recall, micro_f1, macro_precision, macro_recall, macro_f1 = Classification_Performance_Relation(
        prediction_collection, gold_standard_ids, gold_standard_relations)
